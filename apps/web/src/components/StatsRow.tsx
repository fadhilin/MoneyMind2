    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
      <div className="glass-card p-6 rounded-[1.5rem] bg-white dark:bg-black border border-slate-200 dark:border-white/10 group hover:shadow-xl transition-all">
        <div className="flex items-center gap-4 mb-3">
          ...
          <p className="text-sm font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider whitespace-nowrap">Total Pemasukan Hari Ini</p>
        </div>
      ...
      <div className="glass-card p-6 rounded-[1.5rem] bg-white dark:bg-black border border-slate-200 dark:border-white/10 group hover:shadow-xl transition-all">
        <div className="flex items-center gap-4 mb-3">
          ...
          <p className="text-sm font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider whitespace-nowrap">Total Pengeluaran Hari Ini</p>
        </div>
        <h3 className="text-2xl font-bold text-black dark:text-white">
